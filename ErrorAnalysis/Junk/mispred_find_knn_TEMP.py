...
for val_sample_ind in range ( len(val_filenames) ):
    ...
    #print (val_filenames[val_sample_ind])
    #break
    if val_filenames[val_sample_ind] != "000000005314_5_20190906121344255.jpg":
        continue
    print ("Found it")
    print ("val_classes[val_sample_ind]:",val_classes[val_sample_ind])
    print ("sample_pred_class:",sample_pred_class)
    ...
    if sample_pred_class != val_classes[val_sample_ind]:
        ...
        for idx,train_neighbour_id in enumerate(knn_ind):
            ...
            dest_filename = "d" + neigbour_dist + "_" + train_classes[train_neighbour_id] + "_"+ train_classes[train_neighbour_id] + "_" + train_filenames[train_neighbour_id]
            print ("src_full_filename:",src_full_filename)
            print ("neigbour_pred_class:",neigbour_pred_class)
            print ("train_classes[train_neighbour_id]:",train_classes[train_neighbour_id])
