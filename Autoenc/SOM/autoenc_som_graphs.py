# Create charts for Autoencoder's SOM results
#   Src: accuracies.csv (obtained by running create_autoenc_som_clusters.py)
#   Dest: accuracies.png
...
df_graph_filename =  "\\".join ([orange_encoded_activations_folder,"accuracies.png"])
...
plt.title ("Autoencoder's SOM clustering=>Classification")
